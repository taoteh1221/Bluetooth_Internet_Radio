...
github_remote_repo="https://github.com/taoteh1221/Bluetooth_Internet_Radio.git"


# MIRROR git repository remote address
mirror_remote_repo="ssh://taoteh1221@git.code.sf.net/p/bluetooth-internet-radio/code"
